...
try:
    ...
    if janus_pkg_dir.exists():
        ...
        try:
            ...
            logging.getLogger("plugins.janus_reverse_plugin.core.inference_engine").info("Janus库从janus_official.models导入成功")
            ...
            try:
                ...
                JANUS_AVAILABLE = True
                logging.getLogger("plugins.janus_reverse_plugin.core.inference_engine").info("Janus库从models直接导入成功")
                ...
                try:
                    ...
                    logging.getLogger("plugins.janus_reverse_plugin.core.inference_engine").warning(f"所有Janus模块导入方式都失败: {e1}, {e2}, {e3}")
    else:
        JANUS_AVAILABLE = False
        logging.getLogger("plugins.janus_reverse_plugin.core.inference_engine").warning(f"本地Janus包路径不存在: {janus_pkg_dir}")
