...
try:
    ...
    logging.getLogger("plugins.janus_reverse_plugin.core.model_manager").info("Janus库导入成功")
except ImportError:
    JANUS_AVAILABLE = False
    logging.getLogger("plugins.janus_reverse_plugin.core.model_manager").warning("Janus库不可用，模型功能将被禁用")
